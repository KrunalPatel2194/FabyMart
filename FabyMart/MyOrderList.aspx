                    ...
                    <div class="col_1_of_changePassword ">
                        ...
                        <div class="main">
                            <asp:UpdatePanel ID="UpMain" runat="server">
                                <ContentTemplate>
                                    <br />
                                    <div class="shoping_bag_In_OrderList">
                                        <h4>
                                            <div class="float-lt">
                                    ...
                                    <div>
                                        ...
                                        <div class="width_OrderList">
                                            <asp:DataList ID="DataListMyOrder" runat="server" Width="100%" AutoGenerateColumns="false"
                                                AllowSorting="false" DataKeyField="appOrderID" BorderWidth="0" OnItemDataBound="DataListMyOrder_RowDataBound">
                                                <ItemTemplate>
                                                    <div class="OrderList">
                                                        ...
                                                        <div class="OrderBody">
                                                            <asp:DataList ID="DataListSubOrder" runat="server" AutoGenerateColumns="false" AllowSorting="false"
                                                                Width="100%" DataKeyField="appSubOrderID" BorderWidth="0" OnItemDataBound="DataListSubOrder_RowDataBound"
                                                                ...
                                                                <ItemTemplate>
                                                                    <div class="OrderSubBody">
                                                                        ...
                                                                        <div class="OrderPriceQty">
                                                                            ...
                                                                            <div>
                                                                                <div class="btnTotalAmountToBePaid" >
                                        ...
                                        <div id="divslip" runat="server" class="divPopup modalReturnSlip" style="display: none; width: 700px;">
