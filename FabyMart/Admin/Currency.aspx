<%@ Page Title="Currency List" Language="C#" MasterPageFile="~/Admin/Main.master"
                        ...
                        <ContentTemplate>
                            <div class="panel-search">
                                ...
                                <asp:DropDownList runat="server" ID="ddlFields" CssClass="form-control" TabIndex="3">
                                    ...
                                    <asp:ListItem Text="Currency" Value="appCurrency"></asp:ListItem>
                                    <asp:ListItem Text="Rate " Value="appRate"></asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-danger" Text="Delete"
                                        OnClientClick="return ConfirmMessage('Currency','delete')" OnClick="btnDelete_Click" />
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        AllowSorting="true" DataKeyNames="appCurrencyID,appDisplayOrder,appIsActive"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <a href='<%# "CurrencyDetail.aspx?ID=" + objEncrypt.Encrypt(Eval("appCurrencyID").ToString(), appFunctions.strKey) %>'
                                                        title="Edit"><span class="action-icon set-icon"><i class="fa fa-pencil"></i></span>
                                                    </a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderText="Currency" DataField="AppCurrency" SortExpression="AppCurrency" />
                                             <asp:BoundField HeaderText="Currency Code" DataField="appCurrencyCode" SortExpression="appCurrencyCode"  ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%"/>
                                            <asp:BoundField HeaderText="Rate" DataField="AppRate" SortExpression="AppRate"  ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%"/>
                                            <asp:BoundField HeaderText="Symbol" DataField="appSymbol" SortExpression="appSymbol"  ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%"/>
                                            <asp:TemplateField HeaderText="Is Default" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkIsDefault" CommandName="IsDefault" CommandArgument='<%#Eval("appCurrencyID") %>'>
                                            ...
                                            <asp:TemplateField HeaderText="Is Active" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkIsActive" CommandName="IsActive" CommandArgument='<%#Eval("appCurrencyID") %>'>
                                            ...
                                            <asp:TemplateField HeaderText="Display Order" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkUp" CommandName="Up" CommandArgument='<%#Eval("appCurrencyID") %>'
                                                        ToolTip="Up">
                                                        <span class="action-icon set-icon"><i class="fa fa-chevron-up"></i></span>
                                                    </asp:LinkButton>
                                                    <asp:LinkButton runat="server" ID="lnkDown" CommandName="Down" CommandArgument='<%#Eval("appCurrencyID") %>'
                                                        ToolTip="Down">
