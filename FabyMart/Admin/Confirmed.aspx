<%@ Page Title="Confirmed Order List" Language="C#" MasterPageFile="~/Admin/Main.master"
    AutoEventWireup="true" CodeFile="Confirmed.aspx.cs" Inherits="Confirmed" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        function GenerateDocket() {
            ...
            debugger;
            var param = { strIds: document.getElementById("<%=hdnSelectedIDs.ClientID%>").value, strCourierCompanyId: $("#<%= ddlCourierCompany.ClientID%>").val() };
            $.ajax({
                type: "POST",
                async: false,
                url: "Confirmed.aspx/SetCourierCompany",
                ...
                success: function (response) {
                    ...
                    if (response.d[0]) {
                        ...
                        wopen(response.d[1], 'Invoice List', 1000, 500);
            ...
            //document.getElementById('<%= btnDocket.ClientID %>').click();
            //ProductInvoice();
        }
        function ProductInvoice() {
            ...
            if (arIDs != null && arIDs != "") {
                var strval = 'ProductInvoice.aspx?ID=' + arIDs;
                wopen(strval, 'Invoice List', 1200, 600);
                return false;
            }
            else {
                ...
                <div>
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:DropDownList ID="ddlCourierCompany" runat="server" CssClass="form-control">
                                    </asp:DropDownList>
                                    <asp:Button ID="btnProductInvoice" runat="server" CssClass="btn btn-primary" Text="1. Product Invoice"
                                        OnClientClick="GenerateDocket();" />
                                    <asp:Button ID="btnReadyToShip" runat="server" CssClass="btn btn-primary" Text="2. Ready To Ship"
                                        OnClick="btnReadyToShip_Click" />
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        AllowSorting="true" DataKeyNames="appOrderID,appCourierCompanyId,appDocketNo,appInvoiceGenerated,appPaymentMode"
                                        ...
                                        <Columns>
                                                    ...
                                                    <div style="margin-top: 5px;">
                                                        <asp:GridView ID="dgvSubDetail" Width="100%" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Product Info" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="60%"
                                            ...
                                            <%-- <asp:TemplateField HeaderText="Courier Company" ItemStyle-HorizontalAlign="Justify"
                                                ...
                                                <ItemTemplate>
                                                    <div id="divCourierCompany" runat="server">
                                                        <div class="divGrid ">
                                                            <asp:DropDownList ID="ddlCourierCompany" runat="server" CssClass="form-control" Width="130">
                                                            </asp:DropDownList>
                                                        </div>
                                                        <div class="divGrid " style="margin-top: 3px;">
                                                            <asp:TextBox ID="txtCourierCompanyDocket" runat="server" placeholder="Enter Docket No"
                                                                CssClass="form-control" Width="130"></asp:TextBox>
                                                        </div>
                                                        <div class="divGrid " align="right" style="margin-top: 5px;">
                                                            <asp:LinkButton ID="lnkbtnCourierCompany" runat="server" CommandName="SaveCourierCompany"
                                                                CommandArgument='<%#Eval("appSubOrderID") %>' Text="Save" CssClass="btn btn-primary" />
                                                        </div>
                                                    </div>
                                                    <div class="divGrid divPriceValuewithoutPadding">
                                                    ...
                                                    <div class="divGrid ">
                                                        <asp:TextBox ID="txtDocketNo" runat="server" Text='<%#Eval("appDocketNo") %>' placeholder="Enter Docket No"
                                                            CssClass="form-control" Width="130"></asp:TextBox>
                                                    </div>
                                                    <div class="divGrid " align="right" style="margin-top: 5px;">
                                                        <asp:LinkButton ID="lnkAddDocketNo" runat="server" CommandName="addDocketNo" CommandArgument='<%#Eval("appSubOrderID") %>'
                                                            Text="OK" CssClass="btn btn-primary" />
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>--%>
                                            <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="1%"
                                                ...
                                                <ItemTemplate>
                                                    ...
                                                    <div style="display : <%# Eval("appInvoiceURL").ToString() != "" ? "block" : "none" %>">
                                                        <a href='<%#Eval("appInvoiceURL") %>' target="_blank">Invoice URL</a>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Payment" HeaderStyle-Width="10%" ItemStyle-Width="10%"
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblPaymentMode" Font-Bold="true" Font-Size="10" Style="padding: 4px; color: #FFF" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                                ...
                                <asp:HiddenField ID="hdnSelectedIDsForInvoice" Value="" runat="server" />
                                <asp:ValidationSummary ID="vsSearch" ShowMessageBox="true" EnableClientScript="true"
                                    HeaderText="You must Enter Following Fields" ShowSummary="false" runat="server"
                                    ValidationGroup="Search" />
                                <asp:Button runat="server" ID="btnDocket" Style="display: none;" OnClick="GenerateDocketNum_Click" ClientIDMode="Static" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
            </div>
