...
public partial class Currency : PageBase_Admin
{
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        DInfo.ShowMessage("Currency has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
    }
    ...
    {
        Response.Redirect("CurrencyDetail.aspx");
    }
}