<%@ Page Title="Payment Fail Order List" Language="C#" MasterPageFile="~/Admin/main.master"
    AutoEventWireup="true" CodeFile="PaymentFail.aspx.cs" Inherits="PaymentFail" %>
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        AllowSorting="true" DataKeyNames="appOrderID,appPaymentMode,appIsPaid" CssClass="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Total Amount" HeaderStyle-Width="1%" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <div style="color: <%# Convert.ToDecimal( Eval("appAmount").ToString()) >= 0 ? "red" : "green" %>">
                                                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("appAmount")%>'></asp:Label>
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Status" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="1%"
                                                ...
                                                <ItemTemplate>
                                                    <div class="divGrid divPriceValuewithoutPadding">
                                                        <asp:Label ID="lblStatus" runat="server" Style="color: Red;" Text='<%#Eval("appOrderStatus") %>'></asp:Label>
                                                    </div>
