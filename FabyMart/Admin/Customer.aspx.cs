...
public partial class Customer : PageBase_Admin
{
    ...
    private void LoadDataGrid(bool IsResetPageIndex, bool IsSort, string strFieldName = "", string strFieldValue = "")
    {
        ...
        objDataTable = objCustomer.LoadGridData(ddlFields.SelectedValue, txtSearch.Text.Trim());
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        DInfo.ShowMessage("Customer has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
    }
    ...
    private bool Delete(int intPKID)
    {
        ...
        var _with1 = objCustomer;

        if (_with1.LoadByPrimaryKey(intPKID))
        {
            if (System.IO.File.Exists(Server.MapPath(objCustomer.s_AppImage)))
            {
                System.IO.File.Delete(Server.MapPath(objCustomer.s_AppImage));
            }
