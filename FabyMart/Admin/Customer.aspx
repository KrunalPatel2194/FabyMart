<%@ Page Title="Customer List" Language="C#" MasterPageFile="~/Admin/Main.master" AutoEventWireup="true"
                        ...
                        <ContentTemplate>
                            <div class="panel-search">
                                ...
                                <asp:DropDownList runat="server" ID="ddlFields" CssClass="form-control" TabIndex="3">
                                    <asp:ListItem Text="FirstName" Value="appFirstName"></asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-danger" Text="Delete"
                                        OnClientClick="return ConfirmMessage('Customer','delete')" OnClick="btnDelete_Click" />
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        DataKeyNames="appCustomerID,appIsVerified,appIsActive,appIsNewsLetter" CssClass="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <a href='<%# "CustomerDetail.aspx?ID=" + objEncrypt.Encrypt(Eval("appCustomerID").ToString(), appFunctions.strKey) %>'
                                            ...
                                            <asp:TemplateField HeaderText="Images" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:Image ID="img" runat="server" ImageUrl='<%#Eval("appImage") %>' AlternateText='<%#Eval("appFirstName") %>'
                                                        Width="100" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderText="FirstName" DataField="appFirstName" SortExpression="appFirstName" />
                                            <asp:BoundField HeaderText="LastName" DataField="appLastName" SortExpression="appLastName" />
                                            <asp:BoundField HeaderText="EmailID" DataField="appEmailID" SortExpression="appEmailID" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%"/>
                                            <asp:BoundField HeaderText="Mobile" DataField="appMobile" SortExpression="appMobile" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%"/>
                                            <asp:BoundField HeaderText="Gender" DataField="appGender" SortExpression="appGender" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%"/>
                                            <%--<asp:TemplateField HeaderText="Is Active" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkIsActive" CommandName="IsActive" CommandArgument='<%#Eval("appBannerID") %>'>
                                            ...
                                            <%--<asp:TemplateField HeaderText="Display Order" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkUp" CommandName="Up" CommandArgument='<%#Eval("appBannerID") %>'
                                                        ToolTip="Up">
                                                        <span class="action-icon set-icon"><i class="fa fa-chevron-up"></i></span>
                                                    </asp:LinkButton>
                                                    <asp:LinkButton runat="server" ID="lnkDown" CommandName="Down" CommandArgument='<%#Eval("appBannerID") %>'
                                                        ToolTip="Down">
