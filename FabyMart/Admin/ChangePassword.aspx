                                    ...
                                    <div class="entryformmain">
                                        <div class="entryform">
                                            ...
                                            <div class="controlstyle">
                                                ...
                                                <asp:RequiredFieldValidator Display="Dynamic" ID="rfOldPassword" runat="server" ErrorMessage="Old Password"
                                        ...
                                        <div class="entryform">
                                            ...
                                            <div class="controlstyle">
                                                <asp:TextBox ID="txtNewPassword" Width="200" runat="server" CssClass="form-control"
                                                    TabIndex="1" TextMode="Password"></asp:TextBox>
                                                <asp:RequiredFieldValidator Display="Dynamic" ID="rfNewPassword" runat="server" ErrorMessage="New Password"
