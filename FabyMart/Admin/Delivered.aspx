<%@ Page Title="Delivered Order List" Language="C#" MasterPageFile="~/Admin/Main.master"
    AutoEventWireup="true" CodeFile="Delivered.aspx.cs" Inherits="Delivered" %>
                ...
                <div>
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:Button ID="btnComplete" runat="server" CssClass="btn btn-primary" Text="Complete"
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        ...
                                        OnRowDataBound="dgvGridView_RowDataBound" OnSorting="dgvGridView_Sorting" >
                                        ...
                                        <Columns>
                                                        ...
                                                        <asp:GridView ID="dgvSubDetail" Width="100%" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Image" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                                    HeaderStyle-Width="1%">
                                                                    <ItemTemplate>
                                                                        <img src="<%#strServerURL+"admin/"+Eval("appThumbImage") %>" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                            ...
                                            <%-- <asp:BoundField HeaderText="Complete Date" DataField="appCompletedDate" SortExpression="appCompletedDate"
                                                ItemStyle-Width="1%" HeaderStyle-Width="1%" ItemStyle-HorizontalAlign="Center" />--%>
