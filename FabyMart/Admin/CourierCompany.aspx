<%@ Page Title="Courier Company List" Language="C#" MasterPageFile="~/Admin/Main.master" AutoEventWireup="true"
    CodeFile="CourierCompany.aspx.cs" Inherits="CourierCompany" %>
                        ...
                        <ContentTemplate>
                            <div class="panel-search">
                                ...
                                <asp:DropDownList runat="server" ID="ddlFields" CssClass="form-control" TabIndex="3">
                                    <asp:ListItem Text="Courier Company" Value="appCourierCompany"></asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-danger" Text="Delete"
                                        OnClientClick="return ConfirmMessage('Courier Company','delete')" OnClick="btnDelete_Click" />
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False" AllowSorting="true"
                                        DataKeyNames="appCourierCompanyID,appIsActive,appDisplayOrder" CssClass="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <a href='<%# "CourierCompanyDetail.aspx?ID=" + objEncrypt.Encrypt(Eval("appCourierCompanyID").ToString(), appFunctions.strKey) %>'
                                                        title="Edit"><span class="action-icon set-icon"><i class="fa fa-pencil"></i></span>
                                                    </a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                           
                                            <asp:BoundField HeaderText="Courier Company Name" DataField="appCourierCompany" SortExpression="appCourierCompany" ItemStyle-Width="1%"  HeaderStyle-Width="1%"/>
                                           
                                            <asp:BoundField HeaderText="Email" DataField="appEmail" SortExpression="appEmail" ItemStyle-Width="1%" HeaderStyle-Width="1%" />
                                            <asp:BoundField HeaderText="Contact No" DataField="appContactNo" SortExpression="appContactNo" />
                                           
                                            <asp:TemplateField HeaderText="Is Active" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkIsActive" CommandName="IsActive" CommandArgument='<%#Eval("appCourierCompanyID") %>'>
                                            ...
                                            <asp:TemplateField HeaderText="Display Order" ItemStyle-HorizontalAlign="Center"
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkUp" CommandName="Up" CommandArgument='<%#Eval("appCourierCompanyID") %>'
                                                        ToolTip="Up">
                                                        <span class="action-icon set-icon"><i class="fa fa-chevron-up"></i></span>
                                                    </asp:LinkButton>
                                                    <asp:LinkButton runat="server" ID="lnkDown" CommandName="Down" CommandArgument='<%#Eval("appCourierCompanyID") %>'
                                                        ToolTip="Down">
