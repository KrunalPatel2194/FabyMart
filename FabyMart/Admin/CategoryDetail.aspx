<%@ Page Title="Category Detail" Language="C#" MasterPageFile="~/admin/Main.master" AutoEventWireup="true"
    CodeFile="CategoryDetail.aspx.cs" Inherits="CategoryDetail" %>
                            ...
                            <div class="entryformmain">
                                ...
                                <div class="entryform">
                                    <div class="labelstyle">
                                        <span class="mandatory">*</span> Category Name:
                                    </div>
                                    <div class="controlstyle">
                                        <asp:TextBox ID="txtCategoryName" CssClass="form-control" Width="200" runat="server"
                                            TabIndex="2"></asp:TextBox>
                                        <asp:RequiredFieldValidator Display="Dynamic" ID="RFVCategoryName" runat="server" ErrorMessage="Enter Category Name"
                                            ValidationGroup="save" Text="*" ControlToValidate="txtCategoryName" SetFocusOnError="true"
