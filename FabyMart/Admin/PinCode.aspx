<%@ Page Title="PinCode List" Language="C#" MasterPageFile="~/Admin/Main.master"
    AutoEventWireup="true" CodeFile="PinCode.aspx.cs" Inherits="PinCode" %>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-danger" Text="Delete"
                                        OnClientClick="return ConfirmMessage('PIN Code','delete')" OnClick="btnDelete_Click" />
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        AllowSorting="true" DataKeyNames="appPinCodeID,appPinCode" CssClass="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <a href='<%# "PinCodeDetail.aspx?ID=" + objEncrypt.Encrypt(Eval("appPinCodeID").ToString(), appFunctions.strKey) %>'
                                                        title="Edit"><span class="action-icon set-icon"><i class="fa fa-pencil"></i></span>
                                                    </a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderText="PIN Code" DataField="appPinCode" SortExpression="appPinCode" />
                                             <asp:BoundField HeaderText="City" DataField="appCity" SortExpression="appCity" />
                                           
                                            <asp:BoundField HeaderText="State" DataField="appState" SortExpression="appState" />
                                           
                                            <asp:BoundField HeaderText="Country" DataField="appCountry" SortExpression="appCountry" />
                                            <asp:TemplateField HeaderText="Is Active" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkIsActive" CommandName="IsActive" CommandArgument='<%#Eval("appPinCodeID") %>'>
