<%@ Page Title="Shipped Order List" Language="C#" MasterPageFile="~/Admin/Main.master"
    AutoEventWireup="true" CodeFile="Shipped.aspx.cs" Inherits="Shipped" %>
                ...
                <div>
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:Button ID="btnDelivered" runat="server" CssClass="btn btn-primary" Text="Delivered"
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        AllowSorting="true" DataKeyNames="appOrderID,appCourierCompanyId,appDocketNo,appPaymentMode,appManifestGenerated"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Courier Company" ItemStyle-HorizontalAlign="Justify"
                                                ...
                                                <ItemTemplate>
                                                    <div id="divCourierCompany" runat="server">
                                                        ...
                                                        <div class="divGrid " align="right" style="margin-top: 5px;">
                                                            <asp:LinkButton ID="lnkbtnCourierCompany" runat="server" CommandName="SaveCourierCompany"
                                                                CommandArgument='<%#Eval("appOrderID") %>' Text="Save" CssClass="btn btn-primary" />
                                                        </div>
                                                    </div>
                                                    <div class="divGrid divPriceValuewithoutPadding">
                                                    ...
                                                    <div class="divGrid " align="right" style="margin-top: 5px;">
                                                        <asp:LinkButton ID="lnkAddDocketNo" runat="server" CommandName="addDocketNo" CommandArgument='<%#Eval("appOrderID") %>'
