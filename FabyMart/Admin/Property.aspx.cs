...
public partial class Property : PageBase_Admin
{
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        DInfo.ShowMessage("Property has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
    }
    ...
    {
        Response.Redirect("PropertyDetail.aspx");
    }
}