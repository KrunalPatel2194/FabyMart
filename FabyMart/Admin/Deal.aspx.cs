...
public partial class Admin_Deal : PageBase_Admin
{
    ...
    private void LoadDataGrid(bool IsResetPageIndex, bool IsSort, string strFieldName = "", string strFieldValue = "")
    {
        ...
        objDataTable = objDeal.LoadGridData(ddlFields.SelectedValue, txtSearch.Text.Trim());
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        DInfo.ShowMessage("Deal has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
    }
    ...
    {
        Response.Redirect("DealDetail.aspx");
    }
}