...
public partial class Order : PageBase_Admin
{
    tblOrder   objOrder;
    ...
    private void LoadDataGrid(bool IsResetPageIndex, bool IsSort, string strFieldName = "", string strFieldValue = "")
    {
        ...
        objDataTable = objOrder.LoadGridData(ddlFields.SelectedValue, txtSearch.Text.Trim());
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        DInfo.ShowMessage("Order has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
    }
