...
public partial class Banner : PageBase_Admin
{
    tblBanner objBanner;
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        DInfo.ShowMessage("Banner has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
    }
    ...
    {
        Response.Redirect("BannerDetail.aspx");
    }
}