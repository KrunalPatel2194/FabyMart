...
public partial class SubCategory : PageBase_Admin
{
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        DInfo.ShowMessage("Sub Category has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
    }
    ...
    public void VisibleDisplyOrder()
    {
        ...
        {
            dgvGridView.Columns[5].Visible = true ;
        }
        else
        {
            dgvGridView.Columns[5].Visible = false;
        }
    }
