...
public partial class BestSeller : PageBase_Admin
{
    ...
    protected void btnDelete_Click(object sender, EventArgs e)
    {
        ...
        if (IsDelete)
        {
            ...
            {
                LoadBestSeller1(false, false);
            }
        }

        DInfo.ShowMessage("Best Seller has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
        LoadDataGrid(false, false);
    }
