<%@ Page Title="Property List" Language="C#" MasterPageFile="~/Admin/Main.master"
    AutoEventWireup="true" CodeFile="Property.aspx.cs" Inherits="Property" %>
                        ...
                        <ContentTemplate>
                            <div class="panel-search">
                                ...
                                <asp:DropDownList runat="server" ID="ddlFields" CssClass="form-control" TabIndex="3">
                                    ...
                                    <asp:ListItem Text="Name" Value="appPropertyName"></asp:ListItem>
                                    <asp:ListItem Text="Display Name" Value="appDisplayName"></asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <div class="panel-search">
                                <div class="fleft">
                                    <asp:Button ID="btnDelete" runat="server" CssClass="btn btn-danger" Text="Delete"
                                        OnClientClick="return ConfirmMessage('Property','delete')" OnClick="btnDelete_Click" />
                            ...
                            <div class="panel-search">
                                <div class="table-responsive">
                                    <asp:GridView ID="dgvGridView" Width="100%" runat="server" AutoGenerateColumns="False"
                                        AllowSorting="true" DataKeyNames="appPropertyID,appDisplayOrder" CssClass="table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <a href='<%# "PropertyDetail.aspx?ID=" + objEncrypt.Encrypt(Eval("appPropertyID").ToString(), appFunctions.strKey) %>'
                                                        title="Edit"><span class="action-icon set-icon"><i class="fa fa-pencil"></i></span>
                                                    </a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField HeaderText="Property Name" DataField="appPropertyName" SortExpression="appPropertyName" />
                                            <asp:BoundField HeaderText="Display Name" DataField="appDisplayName" SortExpression="appDisplayName" />
                                            <asp:TemplateField HeaderText="Is Predefine" ItemStyle-HorizontalAlign="Center"
                                                ItemStyle-Width="1%" HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <span class="action-icon set-icon <%# Eval("appIsPredefine").ToString().ToLower() == "true" ? "green" : "red" %>">
                                                        <i class="fa <%# Eval("appIsPredefine").ToString().ToLower() == "true" ? "fa-check" : "fa-ban" %>">
                                                        </i></span>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Is ShowIn Search" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="1%"
                                                HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkIsShowInSearch" CommandName="IsShowInSearch" CommandArgument='<%#Eval("appPropertyID") %>'>
                                                        <span class="action-icon set-icon <%# Eval("appIsShowInSearch").ToString().ToLower() == "true" ? "green" : "red" %>"><i class="fa <%# Eval("appIsShowInSearch").ToString().ToLower() == "true" ? "fa-check" : "fa-ban" %>"></i></span>
                                                    </asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Display Order" ItemStyle-HorizontalAlign="Center"
                                                ItemStyle-Width="1%" HeaderStyle-Width="1%">
                                                <ItemTemplate>
                                                    <asp:LinkButton runat="server" ID="lnkUp" CommandName="Up" CommandArgument='<%#Eval("appPropertyID") %>'
                                                        ToolTip="Up">
                                                        <span class="action-icon set-icon"><i class="fa fa-chevron-up"></i></span>
                                                    </asp:LinkButton>
                                                    <asp:LinkButton runat="server" ID="lnkDown" CommandName="Down" CommandArgument='<%#Eval("appPropertyID") %>'
                                                        ToolTip="Down">
