...
public partial class Complete : PageBase_Admin
{
    ...
    private void LoadDataGrid(bool IsResetPageIndex, bool IsSort, string strFieldName = "", string strFieldValue = "")
    {
        ...
        objDataTable = objOrder.GetOrderList(ddlFields.SelectedValue, txtSearch.Text.Trim(), Convert.ToInt32(Enums.Enums_OrderStatus.Complete).ToString());
            ...
            case DataControlRowType.DataRow:
                ...
                if (strSellerOrderID != "")
                {
                    ...
                    if (dgvGrid != null)
                    {
                        ...
                        dgvGrid.DataSource = objSubOrder.GetSubOrderDetailList(strSellerOrderID, Convert.ToInt32(Enums.Enums_OrderStatus.Complete).ToString());
                        dgvGrid.DataBind();
                        objSubOrder = null;
                    }
                }
                ...
                ////    {
                ////        lbltype.Text = "Payment";
                ////        lbltype.ForeColor = System.Drawing.Color.Green;
                ////    }
                ////    else
                ////    {
                ////        lbltype.Text = "Not Payment";
    ...
    protected void dgvSubDetail_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
    {
        if (!string.IsNullOrEmpty(e.CommandArgument.ToString()))
        {
            ...
            {
                objSubOrder = new tblSubOrder();
                objSubOrder.SetSubOrderStatus(Convert.ToInt32(Enums.Enums_OrderStatus.CancelledByAdmin), e.CommandArgument.ToString(), GetCurrentDateTime().ToString(), Convert.ToInt32(Enums.Enums_OrderStatus.Complete).ToString());
                objSubOrder = null;
