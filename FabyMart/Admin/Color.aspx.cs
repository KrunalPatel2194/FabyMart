...
public partial class Color : PageBase_Admin
{
    tblColor objColor;
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        {
            LoadDataGrid(false, false);
            DInfo.ShowMessage("Color has been deleted successfully", Enums.MessageType.Successfull);
        }
        else
        {
            DInfo.ShowMessage("Default Color can not been deleted", Enums.MessageType.Error);
        }
    ...
    {
        Response.Redirect("ColorDetail.aspx");
    }
}