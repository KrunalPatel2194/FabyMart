...
public partial class SendSMS : PageBase_Admin
{
    tblSentSMS objSentSMS;
    ...
    {
        objSentSMS = new tblSentSMS();


        objDataTable = objSentSMS.LoadGridData(ddlFields.SelectedValue, txtSearch.Text.Trim());
    ...
    protected void btnDelete_Click(object sender, System.EventArgs e)
    {
        ...
        DInfo.ShowMessage("SMS has been deleted successfully", Enums.MessageType.Successfull);
        hdnSelectedIDs.Value = "";
    }
    ...
    private bool Delete(int intPKID)
    {
        bool retval = false;
        objSentSMS = new tblSentSMS();
        if (objSentSMS.LoadByPrimaryKey(intPKID))
        {
            objSentSMS.MarkAsDeleted();
            objSentSMS.Save();
        }
        retval = true;
        objSentSMS = null;
    ...
    protected void dgvGridView_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (!string.IsNullOrEmpty(e.CommandArgument.ToString()))
        {
            ...
            //{
            //    objSentSMS = new tblSentSMS();
            //    if (objSentSMS.LoadByPrimaryKey(Convert.ToInt32(e.CommandArgument.ToString())))
            //    {
            //        divTitle.InnerHtml = objSentSMS.AppName;
            //        divDescription.InnerHtml = objSentSMS.AppMessage;
            //        mpeview.Show();
            //    }
            //    objSentSMS = null;
            //}
