<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="SearchViewAll.aspx.cs" Inherits="SearchViewAll" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#<%=ddlSortByPrice.ClientID%>").change(function () {
                if ($(this).val() == "3") {
                    ...
                    //                    $(this).css("font-weight", "bold");
                    $("#aPriceLow").css("font-weight", "normal");
                    document.getElementById("<%=hdnOrderBy.ClientID%>").value = " tblProduct.appProductId Desc";
                    ResetAll();
                } else if ($(this).val() == "2") {
                    //                    $(this).css("font-weight", "bold");
                    $("#aPriceLow").css("font-weight", "normal");
                    document.getElementById("<%=hdnOrderBy.ClientID%>").value = " vw_SertblProductachProduct.appProductId Asc";
                    ResetAll();
                }
                // alert($(this).val())
            });
        ...
        function GetRecords() {
            ...
            var obj = { strPageSize: PageSize, strPageIndex: pageIndex, strProperty: Property, strColor: Color, strSize: Size, strOrderBy: OrderBy, strProduct: Product, strPrice: Price };
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "<%=strServerURL %>SearchViewAll.aspx/LoadProductData",
        ...
        function OnSuccess(response) {
            ...
            $("#divProduct").append(arr[0]);
            document.getElementById("<%=lblTotalProduct.ClientID%>").innerHTML = arr[1];
            ...
            if (!(document.getElementById("divProduct").innerHTML != "" && arr[0] != "")) {

                $("#divMsg").css("display", "block");
                $("#hdnIsNoData").val("True");
            }
            else {
                if (!(document.getElementById("divProduct").innerHTML != "")) {
                    $("#divMsg").css("display", "block");
                }
                if (!(arr[0] != "")) {
                    $("#divMoreData").css("display", "block");
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <%--   <asp:UpdatePanel ID="SerachPannel" runat="server">
        <ContentTemplate>--%>
    <div class="mens">
        <div class="main">
            <div class="wrap">
                ...
                <div class="cont Products_in_right">
                    ...
                    <div class="mens-toolbar">
                        <div class="sort float-lt sort-by" style="visibility:hidden">
                            <div class="float-lt">
                                <label>
                                    Sort : 
                                </label>
                        ...
                        <div class="float-rt">
                            <div class="limiter visible-desktop">
                                <ul class="w_nav">
                                    <li>[ Total Product :<b>
                                        <asp:Label runat="server" ID="lblTotalProduct" Text="0"></asp:Label></b> ]</li>
                                    <li></li>
                                    <%-- <li>Sort : Price - </li>
                    ...
                    <div class="top-box">
                        ...
                        <!-- grids_of_4 -->
                        <DInfo:DisplayInfo runat="server" ID="DInfoSearch" />
                        <div class="grids_of_4" id="divProduct">
                        </div>
                        <div class="clear">
                        </div>
    ...
    <asp:HiddenField ID="hdnTableName" runat="server" Value="" />
    <div>
