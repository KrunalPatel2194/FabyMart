        ...
        <div class="wrap">
            ...
            <fieldset class="input">
                <div class="col_1_of_2 span_1_of_2">
                    ...
                    <div>
                        <asp:TextBox ID="txtMobile" runat="server" placeholder="Mobile Number" onkeypress="return isNumber(event)" MaxLength="10"></asp:TextBox>
                    ...
                    <div>
                        ...
                        <asp:RequiredFieldValidator Display="Dynamic" ID="rfvEmail" runat="server" ErrorMessage="Enter Email"
                            ValidationGroup="register" Text="*" ControlToValidate="txtEmail" SetFocusOnError="true"
                            CssClass="ErrorLabelStyle"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="revEmail" runat="server" Display="Dynamic" ValidationGroup="register"
                    ...
                    <div>
                        ...
                        <asp:RequiredFieldValidator Display="Dynamic" ID="RFVLoginPwd" runat="server" ErrorMessage="Enter Password"
                            ValidationGroup="register" Text="*" ControlToValidate="txtPassword" SetFocusOnError="true"
                            CssClass="ErrorLabelStyle"></asp:RequiredFieldValidator>
                    ...
                    <div>
                        ...
                        <asp:RegularExpressionValidator ID="revConfirmPassword" runat="server" Display="Dynamic"
                            ...
                            CssClass="ErrorLabelStyle"></asp:RegularExpressionValidator>
                        <asp:CompareValidator Display="Dynamic" ID="cmRetryPassword" runat="server" ErrorMessage="Password not Match !"
                            ValidationGroup="register" Text="Password not Match !" ControlToValidate="txtConfirmPassword"
                            ControlToCompare="txtPassword" SetFocusOnError="true" CssClass="ErrorLabelStyle"></asp:CompareValidator>
                    </div>
                     <div>
                        <asp:TextBox runat="server" ID="txtAddress" placeholder="Address" TextMode="MultiLine"
                    ...
                    <div>
                        <div class="float-lt">
                            <asp:Button runat="server" ID="brnCreate" Text="Submit" ValidationGroup="register"
                                OnClick="brnCreate_Click" />
                        </div>
                        <p class="terms">
                            By clicking you agree to the <a href="#">Terms &amp; Conditions</a>.</p>
                        <div class="clear">
                        </div>
                    </div>
                    <%-- <div>
                ...
                <div>
                    <input type="text" value="City" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'City';}"></div>
