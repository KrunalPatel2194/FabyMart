...
public partial class MyOrderList : PageBase_Client
{
    ...
    private void SetRegulerExpression()
    {
        ...
        //REVSiteName.ValidationExpression = RXURLRegularExpressionMsg;
        //REVSiteName.ErrorMessage = "Invalid Site URL (" + RXURLRegularExpressionMsg + ")";
    ...
    protected void dgvCart_RowEditing(object sender, GridViewEditEventArgs e)
    {
    ...
    protected void dgvCart_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        switch (itemType)
        {
            case DataControlRowType.DataRow:
                //string strID = dgvCart.DataKeys[e.Row.RowIndex].Values[0].ToString();
                //int strStatus = Convert.ToInt32(dgvCart.DataKeys[e.Row.RowIndex].Values[2].ToString());

                //if (!(strStatus == Convert.ToInt32(Enums.Enums_OrderStatus.Ordered) || strStatus == Convert.ToInt32(Enums.Enums_OrderStatus.Confirmed) || strStatus == Convert.ToInt32(Enums.Enums_OrderStatus.ReadyToShip)))
                //{
                //    System.Web.UI.HtmlControls.HtmlGenericControl Ul = (System.Web.UI.HtmlControls.HtmlGenericControl)e.Row.FindControl("UlCancel");
