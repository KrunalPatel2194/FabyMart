...
public class PageBase : System.Web.UI.Page
{
    ...
    //public string RXPinRegularExpression = "\\d{0,6}";
    public string RXPinRegularExpression = "[0-9]{6}";
    ...
    public string RXAlphaRegularExpression = "^[a-zA-z]+$";
    ...
    public string RXAlphaRegularExpressionMsg = "Enter aA-zZ";
