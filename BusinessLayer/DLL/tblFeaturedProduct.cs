...
{
    public class tblFeaturedProduct : _tblFeaturedProduct
    {
        public tblFeaturedProduct()
        {
        ...
        public DataTable LoadGridData(string strColumnName, string strColumnValue)
        {
            ...
            string StrQuery = "select tblFeaturedProduct.appFeaturedProductID,tblFeaturedProduct.appProductID,tblFeaturedProduct.appIsActive,tblFeaturedProduct.appDisplayOrder,tblProduct.appProductName,tblColor.appColorName,tblColor.appColorCode,tblColor.appColorImage,tblProductImage.appThumbImage,tblProductImage.appNormalImage,tblProductDetail.appPrice ";
            StrQuery += " from tblFeaturedProduct";
            StrQuery += " inner join tblProduct on tblProduct.appProductID=tblFeaturedProduct.appProductID ";
            ...
            StrQuery += " order by tblFeaturedProduct.appDisplayOrder ";
            base.LoadFromRawSql(StrQuery);
            return base.DefaultView.Table;
        }

        public DataTable LoadFeaturedProduct(string strTopRecord = "")
        {
            ...
            StrQuery += "   tblProductDetail.appProductDetailID,tblFeaturedProduct.appFeaturedProductID,tblFeaturedProduct.appProductID,tblFeaturedProduct.appIsActive,tblFeaturedProduct.appDisplayOrder,tblProduct.appProductName,tblColor.appColorName,tblColor.appColorCode,tblColor.appColorImage,tblProductImage.appSmallImage,tblProductImage.appNormalImage,tblProductDetail.appProductDetailID,case when tblDeal.appDiscountPer is null then cast(ROUND(dbo.tblProductDetail.appPrice,0) as int) else cast(ROUND((isnull(tblProductDetail.appPrice,0)-((isnull(tblProductDetail.appPrice,0)*tblDeal.appDiscountPer)/100)),0) as int) end  appPrice, cast(ROUND(tblProductDetail.appMRP,0) as int) appMRP  ,  case when tblDeal.appDiscountPer is null then Cast(ROUND((100-(isnull(dbo.tblProductDetail.appPrice,0)*100)/isnull(dbo.tblProductDetail.appMRP,0)),0) as int) else Cast(ROUND((100-(isnull( cast((isnull(tblProductDetail.appPrice,0)-((isnull(tblProductDetail.appPrice,0)*tblDeal.appDiscountPer)/100)) as Decimal(10,2)),0)*100)/isnull(dbo.tblProductDetail.appMRP,0)),0) as int) end appOff   ";
            StrQuery += "  from tblFeaturedProduct ";
            StrQuery += "   inner join tblProduct on tblProduct.appProductID=tblFeaturedProduct.appProductID and tblFeaturedProduct.appIsActive=1";
        ...
        public DataTable LoadFeaturedProductList(string strCategoryId, string strSubCategoryId, string strColorId)
        {
            ...
            StrQuery += " and vw_SerachProduct.appProductID not in ( Select tblFeaturedProduct.appProductID From tblFeaturedProduct)";
        ...
        public DataTable LoadAllProductByPaging(string strPageSize, string strPageIndex, string strProperty, string strColor, string strSize, string strOrderBy, string strMinPrice, string strMaxPrice, string strRate)
        {
            ...
            StrQuery += " )AS RowNumber,CASE WHEN tblDeal.appDiscountPer IS NULL THEN tblProductDetail.appPrice ELSE CAST((isnull(tblProductDetail.appPrice, 0) - ((isnull(tblProductDetail.appPrice, 0) * tblDeal.appDiscountPer) / 100)) AS Decimal(10, 2)) END AS AppPrice,tblProductColor.appProductColorID,tblProductDetail.AppSizeID, tblProductDetail.AppMRP,tblFeaturedProduct.appFeaturedProductID,tblFeaturedProduct.appProductID,tblFeaturedProduct.appIsActive,tblFeaturedProduct.appDisplayOrder,tblProduct.appProductName,tblColor.appColorName,tblColor.appColorCode,tblColor.appColorImage,tblProductImage.appLargeImage,tblProductImage.appSmallImage,tblProductImage.appNormalImage,tblProductDetail.appProductDetailID,case when tblDeal.appDiscountPer is null then Cast(ROUND((100-(isnull(dbo.tblProductDetail.appPrice,0)*100)/isnull(dbo.tblProductDetail.appMRP,0)),0) as Decimal(2)) else Cast(ROUND((100-(isnull( cast((isnull(tblProductDetail.appPrice,0)-((isnull(tblProductDetail.appPrice,0)*tblDeal.appDiscountPer)/100)) as Decimal(10,2)),0)*100)/isnull(dbo.tblProductDetail.appMRP,0)),0) as decimal(2,0))  end appOff  from tblFeaturedProduct ";
            StrQuery += "   inner join tblProduct on tblProduct.appProductID=tblFeaturedProduct.appProductID and tblFeaturedProduct.appIsActive=1";
            StrQuery += "   inner join tblProductColor on tblProductColor.appProductID=tblProduct.appProductID ";
            if (strColor == "")
            {
            ...
            if (strProperty != "")
            {
                StrQuery += " INNER JOIN (Select appProductID From tblProductProperty Where tblProductProperty.appPropertyPreValueID in (" + strProperty + ") group by appProductID) tblProductProperty On tblProductProperty.appProductId=tblFeaturedProduct.appProductId";
            }
            StrQuery += " Where 1=1 ";
            ...
            StrQuery += " ) as tblFeaturedProduct";
