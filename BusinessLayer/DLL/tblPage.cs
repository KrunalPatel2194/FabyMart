...
namespace BusinessLayer
{
    public class tblPage : _tblPage
    {
        ...
        {
            strQry = "select MI.appMenuItemId,MI.appMenuItem,P.appPageID,P.appPageTitle,P.appPageContent,P.appPageHeading,P.appSEOWord,P.appSEODescription,P.appAlias,P.appIsDefault,MI.appParentID,MI.appDisplayOrder ";
            ...
            strQry = "select MI.appMenuItemId,MI.appMenuItem,P.appPageID,P.appPageTitle,P.appPageContent,P.appPageHeading,P.appSEOWord,P.appSEODescription,P.appAlias,P.appIsDefault,MI.appParentID ";
